...
# ------------  compiler flags  ------------------------------------------------
DEBUG_CFLAGS    := -DVERSION=\"0.0.1\"  -std=gnu99 -Wall -Werror  -O3 -fvisibility=hidden -s -Wno-unused-result -Wno-maybe-uninitialized -Werror=format-security -g
RELEASE_CFLAGS  := -DVERSION=\"0.0.1\"  -std=gnu99 -Wall -Werror  -O3 -fvisibility=hidden -s -Wno-unused-result -Wno-maybe-uninitialized -Werror=format-security
